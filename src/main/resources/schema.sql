...
ALTER TABLE organization MODIFY inn int  NOT NULL   COMMENT 'ИНН организации';

ALTER TABLE organization MODIFY kpp int  NOT NULL   COMMENT 'КПП организации';
...
CREATE INDEX idx_position_name ON position ( name );

COMMENT ON TABLE position IS 'Справочник должностей';

ALTER TABLE position MODIFY id bigint  NOT NULL  AUTO_INCREMENT COMMENT 'Уникальный идентификатор';

ALTER TABLE position MODIFY name varchar(100)  NOT NULL   COMMENT 'Наименвоание должности';
...
ALTER TABLE docs MODIFY `date` date  NOT NULL   COMMENT 'Дата выдачи документа';
